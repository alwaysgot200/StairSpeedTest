...
std::string vmessConstruct(const std::string &group, const std::string &remarks,
                           ...
                           const std::string &tls, tribool udp = tribool(),
...
std::string ssrConstruct(const std::string &group, const std::string &remarks,
                         ...
                         const std::string &protoparam, bool libev,
...
std::string snellConstruct(const std::string &group, const std::string &remarks,
                           ...
                           const std::string &host, tribool udp = tribool(),
                           tribool tfo = tribool(), tribool scv = tribool());
...
void explodeVless(std::string vless, const std::string &custom_port,
                  nodeInfo &node);
void explodeSSR(std::string ssr, bool ss_libev, bool libev,
...
void explodeStdVLess(std::string vless, const std::string &custom_port,
                     nodeInfo &node);
void explodeShadowrocket(std::string kit, const std::string &custom_port,
                         nodeInfo &node);
...
#endif // SPEEDTESTUTIL_H INCLUDED
