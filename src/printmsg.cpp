...
// 在数组中为 CLI 与 RPC 各增加一条映射，放在正向消息段内（负向错误段之前）
LOOKUP_ITEM SPEEDTEST_MESSAGES[] = {
    {SPEEDTEST_MESSAGE_EOF, "\nSpeed Test done. Press any key to exit..."},
    {SPEEDTEST_MESSAGE_WELCOME,
     "Welcome to Stair Speedtest " VERSION
     "!\nWhich stair do you want to test today? (Supports single "
     "Shadowsocks/ShadowsocksD/ShadowsocksR/V2Ray link and their subscribe "
     "links)\nIf you want to test more than one link, separate them with "
     "'|'.\nLink: "},
    {SPEEDTEST_MESSAGE_MULTILINK,
     "Multiple link provided, parsing all nodes.\n\n"},
    {SPEEDTEST_MESSAGE_FOUNDVMESS, "Found single V2Ray link.\n"},
    {SPEEDTEST_MESSAGE_FOUNDVLESS, "Found single V2Ray link.\n"},
    ...
    {SPEEDTEST_MESSAGE_GROUP,
     "If you have imported an V2Ray subscribe link which doesn't contain a "
     "Group Name, you can specify a custom name below.\nIf you have imported "
     "an Shadowsocks/ShadowsocksR link which contains a Group Name, press "
     "Enter to skip.\nCustom Group Name: "},
    {SPEEDTEST_MESSAGE_GOTSERVER,
     "\nCurrent Server Group: ?1? Remarks: ?2? Index: ?0?/?3?\n"},
    {SPEEDTEST_MESSAGE_STARTPING, "Now performing TCP Ping...Index: ?0?\n"},
    {SPEEDTEST_MESSAGE_STARTGEOIP, "Now performing GeoIP parse...Index: ?0?\n"},
    {SPEEDTEST_MESSAGE_STARTGPING, "Now performing Google Ping...Index: ?0?\n"},
    {SPEEDTEST_MESSAGE_STARTSPEED, "Now performing Speed Test...Index: ?0?\n"},
    {SPEEDTEST_MESSAGE_STARTUPD, "Now performing Upload Test...Index: ?0?\n"},
    {SPEEDTEST_MESSAGE_GOTRESULT,
     "Result: DL.Speed: ?0? Max.Speed: ?1? UL.Speed: ?2? Pk.Loss: ?3? "
     "Avg.Ping: ?4? Google Ping: ?5? NAT Type: ?6?\n"},
    ...
    {SPEEDTEST_MESSAGE_PICSAVINGMULTI,
     "Now exporting picture for group ?0?...\n"},
    {SPEEDTEST_MESSAGE_PICSAVED, "Result picture saved to \"?0?\".\n"},
    {SPEEDTEST_MESSAGE_PICSAVEDMULTI,
     "Group ?0? result picture saved to \"?1?\".\n"},
    {SPEEDTEST_MESSAGE_FETCHSUB, "Downloading subscription data...\n"},
    {SPEEDTEST_MESSAGE_SUBTOOLARGE,
     "Subscription data exceeds size limit (?0? MB). Please increase "
     "advanced.http_get_max_size_mb in base/pref.ini or check your link.\n"},
    ...
    {SPEEDTEST_MESSAGE_GOTGEOIP,
     "Parsed outbound server ISP: ?1?  Country Code: ?2?\n"},
    {SPEEDTEST_MESSAGE_STARTNAT,
     "Now performing UDP NAT Type test..Index: ?0?\n"},
    ...
    {SPEEDTEST_ERROR_UNRECOGFILE,
     "This configure file is invalid. Please make sure this is an "
     "Shadowsocks/ShadowsocksR/v2rayN configuration file or a standard "
     "subscription file.\n"},
    {SPEEDTEST_ERROR_NOCONNECTION, "Cannot connect to server.\n"},
    {SPEEDTEST_ERROR_INVALIDSUB, "Nothing returned from subscribe link. Please "
                                 "check your subscribe link.\n"},
    {SPEEDTEST_ERROR_NONODES,
     "No nodes found. Please check your subscribe link.\n"},
    ...
    {SPEEDTEST_ERROR_NOSPEED,
     "Speed Test returned no speed 2 times. Skipping...\n"},
    {SPEEDTEST_ERROR_SUBFETCHERR, "Cannot fetch subscription data with direct "
                                  "connect. Trying with system proxy...\n"},
    {SPEEDTEST_ERROR_GEOIPERR,
     "Cannot fetch GeoIP information. Skipping...\n"}};
...
LOOKUP_ITEM SPEEDTEST_MESSAGES_RPC[] = {
    ...
    {SPEEDTEST_MESSAGE_PICSAVEDMULTI,
     "{\"info\":\"picsaved\",\"path\":\"?0?\"}\n"},
    {SPEEDTEST_MESSAGE_FETCHSUB, "{\"info\":\"fetchingsub\"}\n"},
    {SPEEDTEST_MESSAGE_SUBTOOLARGE,
     "{\"info\":\"subtoolarge\",\"limit_mb\":\"?0?\"}\n"},
    ...
    {SPEEDTEST_ERROR_SOCKETERR,
     "{\"info\":\"error\",\"reason\":\"socketerr\"}\n"},
    {SPEEDTEST_ERROR_NORECOGLINK,
     "{\"info\":\"error\",\"reason\":\"norecoglink\"}\n"},
    {SPEEDTEST_ERROR_UNRECOGFILE,
     "{\"info\":\"error\",\"reason\":\"unrecogfile\"}\n"},
    {SPEEDTEST_ERROR_NOCONNECTION,
     "{\"info\":\"error\",\"reason\":\"noconnection\",\"id\":?0?}\n"},
    {SPEEDTEST_ERROR_INVALIDSUB,
     "{\"info\":\"error\",\"reason\":\"invalidsub\"}\n"},
    {SPEEDTEST_ERROR_NONODES, "{\"info\":\"error\",\"reason\":\"nonodes\"}\n"},
    {SPEEDTEST_ERROR_NORESOLVE,
     "{\"info\":\"error\",\"reason\":\"noresolve\",\"id\":?0?}\n"},
    {SPEEDTEST_ERROR_RETEST,
     "{\"info\":\"error\",\"reason\":\"retest\",\"id\":?0?}\n"},
    {SPEEDTEST_ERROR_NOSPEED,
     "{\"info\":\"error\",\"reason\":\"nospeed\",\"id\":?0?}\n"},
    {SPEEDTEST_ERROR_SUBFETCHERR,
     "{\"info\":\"error\",\"reason\":\"subfetcherr\"}\n"},
    {SPEEDTEST_ERROR_GEOIPERR,
     "{\"info\":\"error\",\"reason\":\"geoiperr\",\"id\":?0?}\n"}};
...
void printMsgWithDict(int index, bool rpcmode, std::vector<std::string> dict,
